<div id="suggested_posts" data-id="<?php echo $post->ID ?>">
    <h3 class="suggested_posts__title"><?php echo $cj_player_terms['name'] ?></h3>
    <div class="row category-posts">
        ...
        if ( ! empty( $posts_to_exclude_from_players ) ) {
            $suggest_args['post__not_in'] = $posts_to_exclude_from_players;
        }
